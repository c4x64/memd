...
AIN=$(get arch_install_hw_breakpoint)
AUN=$(get arch_uninstall_hw_breakpoint)
SMP=$(get smp_call_function_single)
...
echo "arch_install_hw_breakpoint=$AIN"
echo "arch_uninstall_hw_breakpoint=$AUN"
echo "smp_call_function_single=$SMP"
...
insmod $KO \
    ...
    arch_install_hw_breakpoint=0x$AIN \
    arch_uninstall_hw_breakpoint=0x$AUN \
    smp_call_function_single=0x$SMP \
